    ...
    public function run(): void
    {
        $lessons = [
            ...
            [
                ...
                'content' => "# Impact Velocity and Kinetic Energy\n\n## Introduction\nWhile the size of a meteoroid is important, its **velocity** is equally critical in determining the energy released upon impact.\n\n## The Kinetic Energy Formula\n\n**KE = ½ × m × v²**\n\nWhere:\n- KE = kinetic energy (joules)\n- m = mass (kg)\n- v = velocity (m/s)\n\n### The Squared Relationship\n\nNotice that velocity is **squared** in the equation. This means:\n- Doubling the velocity **quadruples** the energy\n- Tripling the velocity gives **nine times** the energy\n\n## Typical Meteoroid Velocities\n\n### Velocity Ranges:\n- **Minimum**: ~11 km/s (Earth's escape velocity)\n- **Average**: ~17-20 km/s\n- **Maximum**: ~72 km/s (head-on collision)\n\n## Energy Comparison\n\nTwo meteoroids with the same mass (10,000 kg):\n\n**Meteoroid A** (15 km/s):\n- KE = ½ × 10,000 × (15,000)² = 1.125 × 10¹² joules\n- **Equivalent**: 269 tons of TNT\n\n**Meteoroid B** (30 km/s):\n- KE = ½ × 10,000 × (30,000)² = 4.5 × 10¹² joules\n- **Equivalent**: 1,076 tons of TNT\n\n**Meteoroid B has 4 times the energy!**",
                'category' => 'Physics',
                'difficulty_level' => 1,
                'duration_minutes' => 15,
                'icon' => '⚡',
                'practical_task' => 'In the simulator, create a 10-meter radius rock meteoroid and test it at three velocities: 15 km/s, 30 km/s, and 50 km/s. Keep the angle at 45°. Record the kinetic energy (in megatons TNT) for each. Does the energy quadruple when you double the velocity?',
                'learning_objectives' => [
                    'Master the kinetic energy formula',
                    'Calculate impact energy from mass and velocity',
                    'Understand typical meteoroid velocity ranges',
            ...
            [
                ...
                'description' => 'Learn how Earth\'s atmosphere acts as a shield, breaking apart most meteoroids.',
                'content' => "# Atmospheric Entry and Fragmentation\n\n## Introduction\nEarth's atmosphere is our first line of defense against space rocks. This lesson explores how air resistance, heat, and pressure work together to destroy meteoroids.\n\n## The Atmospheric Shield\n\nMost meteoroid destruction happens in the **mesosphere** (50-80 km altitude).\n\n## Three Forces of Destruction\n\n### 1. Aerodynamic Heating\n- **Surface temperature**: 1,650°C to 2,750°C\n- **Plasma formation**: Air ionizes\n- **Ablation**: Surface material vaporizes\n\n### 2. Ram Pressure\n**q = ½ × ρ × v²**\n\nWhen this exceeds material strength, the meteoroid breaks apart.\n\n### 3. Differential Stress\nDifferent parts experience different forces, pulling the object apart.\n\n## Material Strength Rankings:\n1. **Iron**: ~10⁸ Pa (survives often)\n2. **Stone**: ~10⁷ Pa (may fragment)\n3. **Rubble**: ~10⁵ Pa (disintegrates easily)\n\n## Size Threshold\n- **< 10m**: Burns up\n- **10-25m**: Possible airburst\n- **25-100m**: Reaches low altitude/ground\n- **> 100m**: Definitely ground impact",
                'category' => 'Atmospheric Science',
                'difficulty_level' => 2,
                'duration_minutes' => 20,
                'icon' => '🌍',
                'practical_task' => 'Test the atmosphere! Create three 30-meter meteoroids: rock, iron, and rubble. Use velocity 25 km/s and angle 60°. Which fragments? Which survives? Check the "Atmospheric Effects" energy remaining percentage.',
                'learning_objectives' => [
                    'Understand forces that destroy meteoroids',
